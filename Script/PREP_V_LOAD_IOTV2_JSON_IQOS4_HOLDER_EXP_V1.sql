create or replace view COMMON_LAYERS.STAGE_PREPROCESSING.PREP_V_LOAD_IOTV2_JSON_IQOS4_HOLDER_EXP_V1(
	ATOMICCONSENTS,
	RECORDINDEX,
	RECORDFORMATVERSION,
	RECORDSIZE,
	...
	PARTITION_DATE,
	DSS_RECORD_SOURCE COMMENT 'Record source.',
	DSS_LOAD_DATE COMMENT 'Load date.'
) as
SELECT 
EXP3.ATOMICCONSENTS,
...
FROM COMMON_LAYERS.STAGE_PREPROCESSING.PREP_LOAD_IOTV2_EUEXPERIENCE00320055
UNION
...
FROM COMMON_LAYERS.STAGE_PREPROCESSING.PREP_LOAD_IOTV2_JPEXPERIENCE00320055
UNION
SELECT ATOMICCONSENTS,DATA,ORIGINREGION,REQUESTID,SERIALNUMBER,SOURCE_FILE_NAME,EVENT_LOCAL_TIMESTAMP,PARTITION_DATE,DSS_RECORD_SOURCE,DSS_LOAD_DATE
FROM COMMON_LAYERS.STAGE_PREPROCESSING.PREP_LOAD_IOTV2_NZEXPERIENCE002F0052
) EXP3